...
import com.dfd.delfin.databinding.DialogKycSubmittedBinding
...
import com.dfd.delfin.ui.kyc.pan.panKey
import com.dfd.delfin.utils.prefs.UserPrefs
import dagger.android.support.DaggerAppCompatActivity
import javax.inject.Inject
import com.dfd.delfin.R
import com.dfd.delfin.databinding.ViewProgressStepsBinding
...
class NavigationUtils @Inject constructor(
  ...
  fun navigateOnboardingSteps(fromHome: Boolean=false) {
    ...
    if(userPrefs.isLoadBoardClient== false || userPrefs.isLoadBoardSupplier == false) {
      ...
      if(!userPrefs.isUserVerfied){
        ...
        }else if(userPrefs.getLanesPreference().isNullOrEmpty() && userPrefs.truckTypes.isNullOrEmpty() && userPrefs.onboardingStatus == "details_pending" && (userPrefs.vendorType.isNullOrEmpty() || userPrefs.routeType.isNullOrEmpty())){
   ...
   */
  fun navigateToHome() {
    val intent = Intent(activity, com.dfd.delfin.ui.home.activity.home.HomeActivity::class.java).apply {
