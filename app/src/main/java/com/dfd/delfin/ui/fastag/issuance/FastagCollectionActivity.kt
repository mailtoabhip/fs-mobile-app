...
import com.dfd.delfin.api.response.FastagInventoryItem
import com.dfd.delfin.api.response.FastagOrdersResponse
import com.dfd.delfin.databinding.ActivityFastagCollectionBinding
...
class FastagCollectionActivity : BaseActivity<ActivityFastagCollectionBinding, FastagCollectionViewModel>() {
    ...
    private fun confirmCollection() {
        val request = com.dfd.delfin.api.request.ConfirmCollectionRequest(
