...
import com.dfd.delfin.api.response.FieldType
import com.dfd.delfin.api.response.FormField
import com.dfd.delfin.data.dispute.SubmissionState
import com.dfd.delfin.data.dispute.ValidationResult
import com.dfd.delfin.databinding.ActivityFastagDynamicDisputeFormBinding
import com.dfd.delfin.databinding.DialogDisputeSuccessBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.ui.customviews.DynamicFileUploadView
import com.dfd.delfin.ui.customviews.DynamicTextInputView
import com.dfd.delfin.utils.DateUtils
import com.dfd.delfin.utils.DocumentUtils
import com.dfd.delfin.utils.EVENT_FASTAG_DISPUTE_SUBMITTED
import com.dfd.delfin.utils.FileCompressor
import com.dfd.delfin.utils.PROPERTY_DISPUTE_TYPE
...
import com.dfd.delfin.utils.VALUE_FASTAG_DISPUTE_PAGE
...
//        setupTermsAndConditions()
    ...
    private fun showSuccessBottomSheet(srId: String?) {
        ...
        dialogBinding.btnGoToLoads.setOnClickListener {
            bottomSheetDialog.dismiss()
            val intent = com.dfd.delfin.ui.fastag.trucks.FastagTrucksActivity.newIntent(this).apply {
