...
import com.dfd.delfin.databinding.ActivityAssignVehicleBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.ui.fastag.tagAssignment.assign.SelectVehicleAdapter
...
class AssignVehicleActivity : BaseActivity<ActivityAssignVehicleBinding, AssignVehicleViewModel>() {
    ...
    companion object {
        ...
        fun newIntent(
            ...
            items: ArrayList<com.dfd.delfin.api.request.PaymentBreakupItem>? = null
        ): Intent {
    ...
    private fun handleVehicleSelection(vehicle: AvailableVehicle) {
        ...
        when (actionType) {
            ...
            PendingActionType.KYC_DONE -> {
                ...
                val items = intent.getSerializableExtra(EXTRA_ITEMS) as? ArrayList<com.dfd.delfin.api.request.PaymentBreakupItem>
