...
class SearchOriginCityRvAdapter(private val _interface: SearchCityStateRVAdapterInterface) :
    ...
    override fun getBinding(
        ...
        SearchCityStateRvAdapterItemType.CityItem -> ViewSearchCityItemBinding.inflate(inflater, parent, false)
