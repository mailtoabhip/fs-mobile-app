...
import com.dfd.delfin.databinding.ActivityFastagRechargeBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.ui.dialogs.PaymentStatus
import com.dfd.delfin.ui.dialogs.PaymentStatusDialogFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.setFragmentResultListener("PaymentStatusResult", this) { _, bundle ->
            ...
            if (status == PaymentStatus.SUCCESS.name) {
                ...
                val intent = com.dfd.delfin.ui.fastag.trucks.FastagTrucksActivity.newIntent(this)
