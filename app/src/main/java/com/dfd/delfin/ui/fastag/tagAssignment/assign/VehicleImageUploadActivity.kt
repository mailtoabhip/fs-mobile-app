...
import com.dfd.delfin.databinding.ActivityVehicleImageUploadBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.ui.dialogs.SampleImageBottomSheetDialogFragment
...
class VehicleImageUploadActivity :
    ...
    private fun launchFilePicker() {
        val chooserIntent = com.dfd.delfin.utils.extensions.filePickerChooser(
            "Select file",
            com.dfd.delfin.utils.extensions.MimeTypes.IMAGE_JPG,
            com.dfd.delfin.utils.extensions.MimeTypes.IMAGE_JPEG
        )
        try {
    ...
    private fun setupObservers() {
        viewModel.uploadState.observe(this, androidx.lifecycle.Observer { resource ->
            when (resource) {
                is com.dfd.delfin.api.repository.Resource.Loading -> {
                    uiUtils.showProgress()
                }

                is com.dfd.delfin.api.repository.Resource.Success -> {
                ...
                is com.dfd.delfin.api.repository.Resource.Failure -> {
                    uiUtils.hideProgress()
                    dialogUtils.showErrorDialog(
        ...
        viewModel.processStatus.observe(this, androidx.lifecycle.Observer { resource ->
            ...
            when (resource) {
                ...
                is com.dfd.delfin.api.repository.Resource.Loading -> { /* no-op */
                }
            }
        })
    }
    ...
    private fun showVehicleUploadFailedBottomSheet() {
        val bottomSheet =
            com.dfd.delfin.ui.dialogs.RcUploadFailedBottomSheetDialogFragment.newInstance(
            ...
            com.dfd.delfin.ui.dialogs.RcUploadFailedBottomSheetDialogFragment.newInstance(
                ...
                onMaybeLater = {
                    val intent = android.content.Intent(
                        this,
                        com.dfd.delfin.ui.home.activity.home.HomeActivity::class.java
                    )
                    intent.flags =
    ...
    private fun navigateToTagMapping() {
        ...
        val navIntent = android.content.Intent(
            this,
            com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity::class.java
        ).apply {
            putExtra(
                com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity.EXTRA_ORDER_ID,
                orderId
            )
            putExtra(
                com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity.EXTRA_ORDER_ITEM_ID,
                orderItemId.toString()
            )
            putExtra(
                com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity.EXTRA_VEHICLE_CLASS,
                vehicleClass
            )
            putExtra(
                com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity.EXTRA_JOURNEY_ID,
                journeyId
            )
            putExtra(
                com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity.EXTRA_VEHICLE_NUMBER,
                vehicleNumber
            )
            putExtra(
                com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity.EXTRA_TAG_COLOR,
                tagColor
            )
