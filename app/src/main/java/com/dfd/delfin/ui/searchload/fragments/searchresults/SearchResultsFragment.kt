...
import com.dfd.delfin.data.home.bids.HomeBidsRequestAction_AcceptBid
import com.dfd.delfin.data.home.bids.HomeBidsRequestAction_NavigationMap
import com.dfd.delfin.data.home.bids.HomeBidsRequestAction_PlaceBid
...
import com.dfd.delfin.data.home.bids.SUB_REQUEST_TYPE_INTRACITY
import com.dfd.delfin.databinding.FragmentSearchResultsBinding
...
import com.dfd.delfin.ui.biddetails.AcceptAdhocIntracityBidBottomDialog
import com.dfd.delfin.ui.contractDetails.contractDetailsIntent
import com.dfd.delfin.ui.dialogs.BidConfirmReviseDialog
import com.dfd.delfin.ui.home.activity.home.orderRank
import com.dfd.delfin.ui.home.fragments.bids.SearchContractWarningItem_NoLoad
import com.dfd.delfin.ui.home.fragments.bids.SearchLoadWarningItem_NoLoad
...
import com.dfd.delfin.utils.BidSuccessInterface
import com.dfd.delfin.utils.DialogUtils
import com.dfd.delfin.utils.EVENT_CONTRACT_SEARCH_RESULT_SHOWN
import com.dfd.delfin.utils.EVENT_INTERCITY_CONTRACTS_BID_CTA_TAP
import com.dfd.delfin.utils.EVENT_INTERCITY_LOADS_BID_CTA_TAP
import com.dfd.delfin.utils.EVENT_INTRACITY_CONTRACTS_BID_CTA_TAP
import com.dfd.delfin.utils.EVENT_LIST_ITEM
import com.dfd.delfin.utils.EVENT_LOAD_SEARCH_RESULT_SHOWN
import com.dfd.delfin.utils.EVENT_MARKETPLACE_LOADS_BID_CTA_TAP
import com.dfd.delfin.utils.EVENT_PAGE_CONTRACT_SEARCH_RESULTS_NO_ORDERS
import com.dfd.delfin.utils.EVENT_PAGE_CONTRACT_SEARCH_RESULTS_WITH_ORDERS
import com.dfd.delfin.utils.EVENT_PAGE_LOAD_SEARCH_RESULTS_NO_ORDERS
import com.dfd.delfin.utils.EVENT_PAGE_LOAD_SEARCH_RESULTS_WITH_ORDERS
import com.dfd.delfin.utils.EVENT_SEARCH_LOAD
import com.dfd.delfin.utils.EVENT_SEARCH_RESULTS_ORDER_CARD_CLICK
import com.dfd.delfin.utils.EVENT_SEARCH_RESULT_BID_INITIATE
import com.dfd.delfin.utils.EVENT_SEARCH_RESULT_BID_REVISE_INITIATED
import com.dfd.delfin.utils.EVENT_SEARCH_RESULT_BID_REVISE_SUBMITTED
import com.dfd.delfin.utils.EVENT_SEARCH_RESULT_BID_SUBMIT
import com.dfd.delfin.utils.EVENT_SEARCH_SAVED_LOAD
import com.dfd.delfin.utils.PROPERTY_BID_COUNT
import com.dfd.delfin.utils.PROPERTY_DEMAND_TYPE
import com.dfd.delfin.utils.PROPERTY_DESTINATION
import com.dfd.delfin.utils.PROPERTY_NUM_RESULTS
import com.dfd.delfin.utils.PROPERTY_ORDER_COUNT
import com.dfd.delfin.utils.PROPERTY_ORDER_ID
import com.dfd.delfin.utils.PROPERTY_ORDER_LOWEST_BID_VALUE
import com.dfd.delfin.utils.PROPERTY_ORDER_RANK
import com.dfd.delfin.utils.PROPERTY_ORIGIN
...
import com.dfd.delfin.utils.PROPERTY_TRUCK_TYPE
import com.dfd.delfin.utils.PROPERTY_USER_BID_VALUE
import com.dfd.delfin.utils.PROPERTY_USER_BID_VALUE_NEW
import com.dfd.delfin.utils.PROPERTY_USER_BID_VALUE_OLD
import com.dfd.delfin.utils.PROPERTY_USER_ID
import com.dfd.delfin.utils.PROPERTY_VEHICLE_REPORTING_DATE_TIME
import com.dfd.delfin.utils.PaginationScrollListener
import com.dfd.delfin.utils.VALUE_LOAD
import com.dfd.delfin.utils.VALUE_LOAD_PAGE_CONTRACTS_BIDS
import com.dfd.delfin.utils.VALUE_SEARCH
import com.dfd.delfin.utils.VALUE_SEARCH_LISITING
import com.dfd.delfin.utils.extensions.centerX
import com.dfd.delfin.utils.extensions.centerY
