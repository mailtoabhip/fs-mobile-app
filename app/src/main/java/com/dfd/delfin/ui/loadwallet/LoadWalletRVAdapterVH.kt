...
import com.dfd.delfin.databinding.ItemWalletHistoryBinding
...
class WalletHistoryItemVH(binding: ItemWalletHistoryBinding) :
    ...
    override fun bind(
        ...
        if (item.isRefreshing) {
            ...
            binding.textRefreshLabel.text = binding.root.context.getString(com.dfd.delfin.R.string.label_refresh_status)
