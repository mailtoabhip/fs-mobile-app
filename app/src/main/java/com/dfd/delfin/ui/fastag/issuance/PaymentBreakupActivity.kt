...
import com.dfd.delfin.databinding.ActivityPaymentBreakupBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.ui.dialogs.PaymentStatus
import com.dfd.delfin.ui.fastag.wallet.AddMoneyDialogFragment
...
class PaymentBreakupActivity : BaseActivity<ActivityPaymentBreakupBinding, PaymentBreakupViewModel>() {
    ...
    private var items: List<com.dfd.delfin.api.request.PaymentBreakupItem> = emptyList()
    private var orderId = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items = intent.getSerializableExtra(EXTRA_ITEMS) as? ArrayList<com.dfd.delfin.api.request.PaymentBreakupItem> ?: arrayListOf()
