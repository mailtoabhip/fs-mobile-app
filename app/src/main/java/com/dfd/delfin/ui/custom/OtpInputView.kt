...
import com.dfd.delfin.databinding.ViewOtpInputBinding
import com.dfd.delfin.databinding.ViewOtpInputCellBinding
...
class OtpInputView @JvmOverloads constructor(
    ...
    private fun shakeCells() {
        ...
        val distance = resources.getDimension(com.dfd.delfin.R.dimen.distance_otp_vibrate)
