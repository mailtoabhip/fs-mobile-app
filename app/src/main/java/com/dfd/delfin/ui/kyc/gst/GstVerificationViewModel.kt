...
class GstVerificationViewModel@Inject constructor(
    ...
    /* error live data */
    var errorLiveData = MutableLiveData<Pair<com.dfd.delfin.ui.kyc.gst.AuthenticationUIError, String?>>()
    ...
    fun verifyRequestOtp(otp: CharArray) {
        ...
        if(gstDetailData.value!=null && gstDetailData.value?.gstNumber!=null) {
            ...
            errorLiveData.postValue(Pair(com.dfd.delfin.ui.kyc.gst.AuthenticationUIError.InvalidGSTNumber, "Invalid GST Number"))
        }
    }
