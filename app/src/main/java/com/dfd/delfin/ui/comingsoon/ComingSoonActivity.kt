package com.dfd.delfin.ui.comingsoon
...
import com.dfd.delfin.databinding.ActivityComingSoonBinding
...
class ComingSoonActivity : BaseActivity<ActivityComingSoonBinding, ComingSoonViewModel>() {
    ...
    override fun onPostCreate(savedInstanceState: Bundle?) {
        ...
        if (com.dfd.delfin.utils.WindowInsetsUtils.isEdgeToEdgeEnforced()) {
            com.dfd.delfin.utils.WindowInsetsUtils.applyTopSystemWindowInsets(binding.parentLL)
        }
