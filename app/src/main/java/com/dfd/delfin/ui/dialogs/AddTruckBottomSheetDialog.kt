...
import com.dfd.delfin.databinding.DialogBottomAddTruckBinding
...
class AddTruckBottomSheetDialog(
    ...
    private fun showTruckSizeDialog(type: String) {
        ...
        val bindingDialog = com.dfd.delfin.databinding.DialogBottomTruckValueBinding.inflate(layoutInflater)
