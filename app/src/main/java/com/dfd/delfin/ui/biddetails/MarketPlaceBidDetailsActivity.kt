...
import com.dfd.delfin.databinding.ActivityMarketplaceBidDetailsBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.databinding.DialogBidRevisedSuccessBinding
import com.dfd.delfin.ui.home.activity.home.homeActivityIntent
import com.dfd.delfin.utils.EVENT_MARKETPLACE_LOADS_BID_SUBMIT
...
import com.dfd.delfin.utils.VALUE_LOAD_PAGE_LOADS_BIDS
...
class MarketPlaceBidDetailsActivity : BaseActivity<ActivityMarketplaceBidDetailsBinding, MarketPlaceBidDetailsViewModel>() {
    ...
    private fun updateUIForBidState(existingBid: com.dfd.delfin.data.bids.TransactionBid?) {
        if (existingBid != null) {
    ...
    private fun updateUIWithTransactionDetails(transaction: com.dfd.delfin.data.home.bids.HomeBidsRequestItemData) {
        ...
        val formattedPrice = if (transaction.targetPrice != null && transaction.targetPrice!! > 0) {
            "₹${com.dfd.delfin.utils.StringUtils.formatAmount(transaction.targetPrice!!)}"
        } else {
            "₹0"
        }
