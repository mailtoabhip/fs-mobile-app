...
import com.dfd.delfin.databinding.ActivityEpodDetailsBinding
import com.dfd.delfin.databinding.DialogEpodSuccessBinding
import com.dfd.delfin.ui.base.BaseActivity
import com.dfd.delfin.utils.BitmapUtils
import com.dfd.delfin.utils.EVENT_POD_UPLOAD
...
import com.dfd.delfin.utils.VALUE_FAILURE
import com.dfd.delfin.utils.VALUE_SUCCESS
...
import com.dfd.delfin.utils.VALUE_POD_STATUS
...
class UploadImageActivity : BaseActivity<ActivityEpodDetailsBinding, UploadImageViewModel>(),
  ...
  private fun setupInformationBanner() {
    if (intermittentPayableAmount != null && intermittentPayableAmount!! > 0) {
      ...
      val formattedAmount = com.dfd.delfin.utils.StringUtils.formatAmount(intermittentPayableAmount!!)
  ...
  private fun dispatchFileIntent() {
    ...
    private fun extractS3Path(docUrl: String): String? {
        return try {
            ...
            val bucket = com.dfd.delfin.config.AWSConfig.Bucket.value()
            val region = com.dfd.delfin.config.AWSConfig.ServerRegion.value()
