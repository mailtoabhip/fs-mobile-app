...
import com.dfd.delfin.databinding.ActivityFastagKycBinding
...
class FastagKycActivity : BaseActivity<ActivityFastagKycBinding, FastagKycViewModel>() {
    ...
    private var orderId = ""
    private var items: ArrayList<com.dfd.delfin.api.request.PaymentBreakupItem> = arrayListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items = intent.getSerializableExtra(PaymentBreakupActivity.EXTRA_ITEMS) as? ArrayList<com.dfd.delfin.api.request.PaymentBreakupItem>
            ?: arrayListOf()
