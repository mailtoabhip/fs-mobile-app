...
import com.dfd.delfin.injection.qualifier.ActivityContext
import com.dfd.delfin.injection.scope.ActivityScope
import com.dfd.delfin.ui.accountaction.AccountActionActivity
import com.dfd.delfin.ui.accountdetails.AccountDetailsActivity
import com.dfd.delfin.ui.accountrole.AccountRoleActivity
import com.dfd.delfin.ui.auth.AccountDeletionActivity
import com.dfd.delfin.ui.auth.AuthenticationActivity
import com.dfd.delfin.ui.auth.InvalidActivity
import com.dfd.delfin.ui.biddetails.MarketPlaceBidDetailsActivity
import com.dfd.delfin.ui.bids.TripsActivity
import com.dfd.delfin.ui.businessverification.BusinessVerificationActivity
import com.dfd.delfin.ui.comingsoon.ComingSoonActivity
import com.dfd.delfin.ui.contractDetails.ContractDetailsActivity
import com.dfd.delfin.ui.contractDetails.PlacementsContractDetailsActivity
import com.dfd.delfin.ui.fastag.fastag_details.FastagTransactionDetailsActivity
import com.dfd.delfin.ui.fastag.issuance.AddVehicleActivity
import com.dfd.delfin.ui.fastag.issuance.BuyFasTagActivity
import com.dfd.delfin.ui.fastag.issuance.BuyFasTagFragmentsBindingModule
import com.dfd.delfin.ui.fastag.issuance.FastagCollectionActivity
import com.dfd.delfin.ui.fastag.issuance.FastagKycActivity
import com.dfd.delfin.ui.fastag.issuance.PaymentBreakupActivity
import com.dfd.delfin.ui.fastag.issuance.PaymentMethodActivity
import com.dfd.delfin.ui.fastag.issuance.SelectFasTagActivity
import com.dfd.delfin.ui.fastag.tagAssignment.pendingActions.PendingActionsActivity
import com.dfd.delfin.ui.fastag.tagAssignment.pendingActions.AssignVehicleActivity
import com.dfd.delfin.ui.fastag.tagAssignment.assign.RCUploadActivity
import com.dfd.delfin.ui.fastag.tagAssignment.assign.kyv.KYVFastagImageUploadActivity
import com.dfd.delfin.ui.fastag.tagAssignment.assign.VehicleDetailsActivity
import com.dfd.delfin.ui.fastag.tagAssignment.assign.VehicleImageUploadActivity
import com.dfd.delfin.ui.fastag.qdr.FastagDisputeIssuesActivity
import com.dfd.delfin.ui.fastag.qdr.FastagDynamicDisputeFormActivity
import com.dfd.delfin.ui.fastag.qdr.FastagRaiseDisputeActivity
import com.dfd.delfin.ui.fastag.qdr.FastagTransactionSelectionActivity
import com.dfd.delfin.ui.fastag.recharge.FastagRechargeActivity
import com.dfd.delfin.ui.fastag.tagMapping.TagMappingActivity
import com.dfd.delfin.ui.fastag.trucks.FastagTrucksActivity
import com.dfd.delfin.ui.home.activity.bank.BankTransferActivity
import com.dfd.delfin.ui.home.activity.docket.DocketUpdateActivity
import com.dfd.delfin.ui.home.activity.fuel.ActiveTripsActivity
import com.dfd.delfin.ui.home.activity.fuelcard.CreateFuelCardActivity
import com.dfd.delfin.ui.home.activity.home.HomeActivity
import com.dfd.delfin.ui.home.activity.transactiondetail.TransactionDetailActivity
import com.dfd.delfin.ui.home.activity.transactionlist.TransactionsActivity
import com.dfd.delfin.ui.home.activity.wallet.WalletOnboardingActivity
import com.dfd.delfin.ui.home.fragments.HomeFragmentsBindingModule
import com.dfd.delfin.ui.home.fragments.loads_truck.HomeTruckLoadsFragmentBindingModule
import com.dfd.delfin.ui.invoicereview.InvoiceReviewActivity
import com.dfd.delfin.ui.kyc.aadhaar.AadhaarVerificationActivity
import com.dfd.delfin.ui.kyc.address.AddressActivity
import com.dfd.delfin.ui.kyc.address.CommunicationAddressActivity
import com.dfd.delfin.ui.kyc.documentverification.DocumentVerificationActivity
import com.dfd.delfin.ui.kyc.gst.GstVerificationActivity
import com.dfd.delfin.ui.kyc.identityverification.IdentityVerificationActivity
import com.dfd.delfin.ui.kyc.pan.PanVerificationActivity
import com.dfd.delfin.ui.ledger.ConsolidatedPageActivity
import com.dfd.delfin.ui.loadwallet.LoadWalletActivity
import com.dfd.delfin.ui.loadwallet.RechargeDetailsActivity
import com.dfd.delfin.ui.loadwallet.TransactionDetailsActivity
import com.dfd.delfin.ui.loadwallet.WalletFragmentBindingModule
import com.dfd.delfin.ui.onboarding.BasicDetailsActivity
import com.dfd.delfin.ui.onboarding.OnboardingActivity
import com.dfd.delfin.ui.payment.PaymentWebViewActivity
import com.dfd.delfin.ui.paymentdetails.PaymentDetailsActivity
import com.dfd.delfin.ui.paymentdetails.VendorPolicyActivity
import com.dfd.delfin.ui.placementdetails.PlacementDetailsActivity
import com.dfd.delfin.ui.profile.BankDetailsActivity
import com.dfd.delfin.ui.profile.HelpSupportActivity
import com.dfd.delfin.ui.profile.MyProfileActivity
import com.dfd.delfin.ui.profile.PlacementsActivity
import com.dfd.delfin.ui.profile.PlacementsFragmentsBindingModule
import com.dfd.delfin.ui.profile.kycdetails.ProfileKYCDetailsActivity
import com.dfd.delfin.ui.profile.kycdetails.fragments.ProfileKYCFragmentBindingModule
import com.dfd.delfin.ui.profile.profiledetails.ProfileDetailsActivity
import com.dfd.delfin.ui.profile.raterewards.ShareRateGetRewardsActivity
import com.dfd.delfin.ui.profile.raterewards.fragments.ShareRateGetRewardsFragmentBindingModule
import com.dfd.delfin.ui.searchCity.SearchCity
import com.dfd.delfin.ui.searchcitystate.SearchCityStateActivity
import com.dfd.delfin.ui.searchcitystate.SearchOriginCityActivity
import com.dfd.delfin.ui.searchload.SearchLoadActivity
import com.dfd.delfin.ui.searchload.fragments.SearchLoadFragmentsBindingModule
import com.dfd.delfin.ui.searchongoingtrip.SearchOngoingTripActivity
import com.dfd.delfin.ui.searchtrip.SearchActivity
import com.dfd.delfin.ui.selectroute.activity.SelectRouteActivity
import com.dfd.delfin.ui.selectroute.fragments.SelectRouteFragmentsBindingModule
import com.dfd.delfin.ui.selectroutewelcome.SelectRouteWelcomeActivity
import com.dfd.delfin.ui.sharerate.ShareRateActivity
import com.dfd.delfin.ui.splash.StartRoutingActivity
import com.dfd.delfin.ui.team.TeamMembersActivity
import com.dfd.delfin.ui.tripdetails.ImageViewActivity
import com.dfd.delfin.ui.tripdetails.TripDetailsActivity
import com.dfd.delfin.ui.tripdetails.UploadImageActivity
import com.dfd.delfin.ui.trucks.AddTruckPathwayActivity
import com.dfd.delfin.ui.trucks.TruckActivity
import com.dfd.delfin.ui.userroutes.ManageRouteActivity
import com.dfd.delfin.ui.userroutes.UserRoutesActivity
import dagger.Binds
