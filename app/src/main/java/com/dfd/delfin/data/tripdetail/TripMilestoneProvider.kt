...
import com.dfd.delfin.data.home.trips.TicketStatus
import com.dfd.delfin.data.home.trips.TripInvoiceStatus
object TripMilestoneProvider {
    ...
    /*Returns current date if invalid timestamp was passed as param*/
     fun formatDateString(timestamp: String?): String? {
        ...
        return try {
            val date = com.dfd.delfin.utils.DateUtils.parseDate(
                timestamp,
                com.dfd.delfin.utils.DatePatterns.OrionDateFormat
            )
