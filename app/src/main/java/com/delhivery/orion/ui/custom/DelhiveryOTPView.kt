...
import com.delhivery.orion.databinding.ViewDelhiveryOtpBinding
import com.delhivery.orion.databinding.ViewDelhiveryOtpItemBinding
...
class DelhiveryOTPView(
  ...
  /* View interface */
  var otpViewInterface: DelhiveryOTPViewInterface? = null
 ...
 */
interface DelhiveryOTPViewInterface {
...
/* OTP Digit count */
private const val OTPDigitsCount = 4