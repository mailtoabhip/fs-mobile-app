...
const val EVENT_HOME_MY_TRUCKS_TAB_CLICK= "home_ny_trucks_tab_click"
...
const val EVENT_PAGE_LOAD_ORDER_DETAILS_WITHOUT_EXISTING_BID= "page_load_order_details_without_existing_bid"
const val EVENT_PAGE_LOAD_ORDER_DETAILS_WITH_EXISTING_BID= "page_load_order_details_with_existing_bid"
...
const val PROPERTY_ANDROID_ID = "android_id"
const val PROPERTY_ANDROID_APP_VERSION = "android_app_version"
const val PROPERTY_BASE_CITY = "base_city"
const val PROPERTY_CREATION_DATE = "creation_date"
const val PROPERTY_PAYMENT_MODE = "payment_mode"
const val PROPERTY_CAN_RAISE_INVOICE = "can_raise_invoice"
const val PROPERTY_ONBOARD_STATUS = "onboard_status"
const val PROPERTY_UUID = "uuid"
const val PROPERTY_PHONE_NO = "phone_no"
const val PROPERTY_CREATED_BY = "created_by"
const val PROPERTY_COMPANY_NAME = "company_name"
const val PROPERTY_DEMAND_TYPE = "demand_type"
const val PROPERTY_OWNS_TRUCKS = "owns_trucks"
const val PROPERTY_NAME = "name"
const val PROPERTY_IS_SUPPLIER_ENABLED = "is_supplier_enabled"
const val PROPERTY_BASE_CITY_COD = "base_city_code"
const val PROPERTY_PHYSICAL_VERIFICATION = "physical_verification"
const val PROPERTY_STATUS = "status"
const val PROPERTY_SUB_STATUS = "sub_status"
const val PROPERTY_IS_KYC_VERIFIED = "is_kyc_verified"
const val PROPERTY_RECEIVE_WHATSAPP_NOTIFICATIONS = "receive_whatsapp_notifications"
const val PROPERTY_IS_LOAD_BOARD_SUPPLIER = "is_load_board_supplier"
