  ...
  fun trackEvent(
    ...
    if (analytics != null) {
      ...
      if (!TextUtils.isEmpty(userPrefs.phoneNumber)) {
        analytics.setUserProperty("phone_number", userPrefs.phoneNumber)
      }
...
val EVENT_PLACE_BID = "place_bid"
val EVENT_ACCEPT_BID = "accept_bid"
val EVENT_EDIT_BID = "edit_bid"
...
val EVENT_LOAD_INFO = "info_item"
val EVENT_EDIT_ROUTE = "edit_route"
val EVENT_FOOTER = "footer"
