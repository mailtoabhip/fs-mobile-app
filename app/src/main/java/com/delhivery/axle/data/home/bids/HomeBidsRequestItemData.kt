...
data class HomeBidsRequestItemData(
  ...
  @SerializedName("intermediary_stop2_city") val stop1State: String,
  ...
  @SerializedName("loading_location_pincode") val loadingLocationPincode: String?,
  @SerializedName("unloading_location_pincode") val unloadingLocationPincode: String?,
