...
data class HomeBidsRequestItemData(
  ...
  @SerializedName("intracity_days") val intracityDays: String?,
  @SerializedName("intracity_kms") val intracityKms: String?,
  @SerializedName("intracity_hours") val intracityHours: String?,
