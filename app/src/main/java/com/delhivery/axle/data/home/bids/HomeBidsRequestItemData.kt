...
data class HomeBidsRequestItemData(
  ...
  @SerializedName("intermediary_stop1_address_line1") val intermediaryStop1Address: String?,
  @SerializedName("intermediary_stop2_address_line2") val intermediaryStop2Address: String?,
  ...
  @SerializedName("intermediary_pickup_stop1_address_line2") val pickup1Address: String,
  @SerializedName("intermediary_pickup_stop2_address_line2") val pickup2Address: String,
