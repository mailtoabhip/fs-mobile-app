...
//      }else
                ...
                override fun onTick(millisUntilFinished: Long) {
                  try {
                    ...
                    if (hours == 0) {
                      ...
                      binding.bidClosingStatusTime.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.destructive_red))
                    }else  if(hours<=12){
                      binding.bidClosingStatusTime.visibility = View.VISIBLE
                      binding.bidClosingStatusTime.text = hrs+ " hrs"
                      binding.bidClosingStatusTime.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.heading_black))
                    }else{
                ...
                when (state) {
                    ...
                    is BidDetailsContractCancelled ->{
                        ...
                        /*  binding.bottomLay.visibility = View.VISIBLE
                          ...
                          binding.confirmedText.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.color_hint))
                          binding.clBidYet.visibility = View.GONE
                          binding.biddingIcon.setImageDrawable( ContextCompat.getDrawable(
                            this@PlacementsContractDetailsActivity,
                               ...
                               if(data.isItLHContract() || data.isItIntraCityContract()){
                                 ...
                                 if (lowestTBid?.bidAmount != null) {
                                   ...
                                   if (userBid?.bidAmount?.equals(lowestTBid?.bidAmount) == true) {
                                     binding.bidStatus.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.bid_placed_green))
                                     binding.bidStatus.background = ContextCompat.getDrawable(this@PlacementsContractDetailsActivity,R.drawable.bg_all_rounded_won)
                                     ...
                                     binding.bidStatus.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.destructive_red))
                                     binding.bidStatus.background = ContextCompat.getDrawable(this@PlacementsContractDetailsActivity,R.drawable.bg_all_rounded_lost_red)
                                 ...
                                 if (lowestTBid?.bidAmount != null) {
                                   if (userBid?.bidAmount?.equals(lowestTBid?.bidAmount) == true ) {
                                     binding.nonExpressBidStatus.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.bid_placed_green))
                                     binding.nonExpressBidStatus.background = ContextCompat.getDrawable(this@PlacementsContractDetailsActivity,R.drawable.bg_all_rounded_won)
                                     ...
                                     binding.nonExpressBidStatus.setTextColor(ContextCompat.getColor(this@PlacementsContractDetailsActivity,R.color.destructive_red))
                                     binding.nonExpressBidStatus.background = ContextCompat.getDrawable(this@PlacementsContractDetailsActivity,R.drawable.bg_all_rounded_lost_red)
                        ...
                        if(userBid?.status()==Open){
                            ...
                            if(forPlacement){
                                ...
                                binding.cardInput.confirmedBidCl.btnAction.setOnClickListener {
                                    startActivity(homeActivityIntent("placement", this@PlacementsContractDetailsActivity))
    ...
    private fun showPayoutSlabs(data:HomeBidsRequestItemData) {
        if(data.paymentSlabs!=null && data.isItIntraCityContract()&& data.transactionStatus!=TransactionStatus.Cancelled.statusId) {
            ...
            val contractPaymentSlabsAdapter  = ContractPaymentSlabsAdapter(paymentSlabsArray,data,this@PlacementsContractDetailsActivity)
    ...
    /*   fun setBidStatusHeaderLayout(data:HomeBidsRequestItemData) {
         ...
         if (data.isUnderOneHour()) {
           ...
           GlideApp.with(this@PlacementsContractDetailsActivity)
