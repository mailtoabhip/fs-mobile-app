...
BaseExpandableDataRVAdapter<BaseConsolidatedPageRVAdapterItem<*>, ViewDataBinding, BaseViewHolder<*>>(
    ...
    override fun getBinding(
        ...
        Month -> ViewConsolidatedPageMonthItemBinding.inflate(inflater, parent, false)
    ...
    override fun onGroupExpand(position: Int, ledgers: List<ConsolidatedLedgerItemData>) {
    ...
    override fun onGroupCollapse(position: Int, ledgers: List<ConsolidatedLedgerItemData>) {
        for (data in ledgers) {
    ...
    override fun createVH(binding: ViewDataBinding) = when (binding) {
        ...
        is ViewConsolidatedPageMonthItemBinding -> ConsolidatedPageMonthItemVH(binding)
    ...
    override fun bindVH(holder: BaseViewHolder<*>, item: BaseConsolidatedPageRVAdapterItem<*>) {
        when (holder){
            ...
            is ConsolidatedPageMonthItemVH -> holder.bind(item as ConsolidatedPageMonthItem, _interface)
