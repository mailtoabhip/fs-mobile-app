        ...
        if (!error && _tRes != null) {
          mutableListOf<Pair<BaseHomeContractsRVAdapterItem<*>, DataRVAdapterOperationType>>().apply {
            ...
            if (_tRes.fourth.transactions.isEmpty() && _tRes.fifth.transactions.isEmpty()) {
              ...
              add(Pair(HomeContractsFilterItem(HomeContractsFilterItemData("",isInternal, expressCount ,nonExpressCount,0,if(demandType=="Intracity") "Intracity" else userPrefs.demandType)), AddUpdate))
