...
//              getString(string.unallocated_bulk_order) + (_transaction.unAllocatedVolume)?.toInt() + " MT"
                    ...
                    /*  if(_transaction!!.requiredAtDraw()!=null){
                      binding.textDateTime.setCompoundDrawablesWithIntrinsicBounds(
                          ...
                          this@PlacementsBidDetailsActivity, _transaction!!.requiredAtDraw()!!
                      ), null
                      )
                      }*/
                }
                           ...
                           .apply {
                             ...
                             if (viewModel.openConfirmBid) {
                               ...
                               BidConfirmReviseDialog(
                                 this@PlacementsBidDetailsActivity,data, viewModel, 0
                               ).show()
                             }
                             binding.numLay.visibility = View.GONE
                             binding.bottomLay.visibility = View.VISIBLE
                               ...
                               if (lowestTBid?.bidAmount != null) {
                                 if (userBid?.bidAmount?.equals(lowestTBid?.bidAmount) == true) {
                                   ...
                                   binding.tvCorr.setTextColor(
                                     ContextCompat.getColor(this@PlacementsBidDetailsActivity, R.color.bid_placed_green)
                                   )
                                   binding.llBidStatus.background =  ContextCompat.getDrawable(this@PlacementsBidDetailsActivity,
                                     R.drawable.bg_all_round_corner_light_green_12
                                   )
                                 } else {
                                   binding.tvCorr.setBackground(
                                   ...
                                   binding.tvCorr.setTextColor(ContextCompat.getColor(this@PlacementsBidDetailsActivity as Context, R.color.bid_placed_red))
                                 }
                               } else {
                                 binding.tvCorr.setBackground(
                                   ContextCompat.getDrawable(this@PlacementsBidDetailsActivity,
                                 ...
                                 binding.tvCorr.setTextColor(ContextCompat.getColor(this@PlacementsBidDetailsActivity, R.color.bid_placed_red))
                               }
                             ...
                             binding.status.setBackgroundColor(ContextCompat.getColor(this@PlacementsBidDetailsActivity, R.color.status_active))
                    ...
                    is BidDetailsUserBidState_RejectedBid -> {
                        ...
                        /*  ViewBidDetailsRejectedBidBinding.inflate(
                            ...
                            .apply {
                              ...
                              binding.priceLay.visibility = View.VISIBLE
                              binding.status.setBackgroundColor(ContextCompat.getColor(this@PlacementsBidDetailsActivity, R.color.status_lost_bg))
                              binding.status.setTextColor(ContextCompat.getColor(this@PlacementsBidDetailsActivity, R.color.status_lost_bid))
                              binding.bottomLay.visibility = View.GONE
                            }*/
                    }
                    is BidDetailsUserBidState_CancelledBid -> {
                        ...
                        /* ViewBidDetailsCancelledBidBinding.inflate(
                           ...
                           .apply {
                             ...
                             binding.textTargetPriceLabel.text = "Your Bid"
                             binding.priceLay.visibility = View.VISIBLE
                             binding.status.setTextColor(ContextCompat.getColor(this@PlacementsBidDetailsActivity, R.color.status_lost))
                             binding.bottomLay.visibility = View.GONE
                           }*/
                    }
                         ...
                         //     binding.bidLay.visibility = View.GONE
                          //    binding.bottomLay.visibility = View.GONE
                              ...
                              rvBidSummary.apply {
                                ...
                                adapter = this@PlacementsBidDetailsActivity.adapter
