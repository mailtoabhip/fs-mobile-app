...
import com.delhivery.axle.databinding.FragmentIntracitySearchResultsBinding
...
class IntracitySearchResultsFragment:SearchLoadBaseFragment<FragmentIntracitySearchResultsBinding, SearchResultsViewModel>(),
  ...
  companion object{
    val _instance: IntracitySearchResultsFragment by lazy { IntracitySearchResultsFragment() }
  }

  override fun getViewModelClass()=SearchResultsViewModel::class.java

  override fun layoutId()= R.layout.fragment_intracity_search_results
  ...
  private fun setupSpinners() {
    binding.spinnerTruckType.apply {
      isEnabled = false
      isClickable = false
    }
