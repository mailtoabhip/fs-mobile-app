 ...
 */
class HomePodFragment : HomeBaseFragment<FragmentHomeBidsBinding, HomePodViewModel>(),
  ...
  companion object {
    /* singleton instance */
    val _instance: HomePodFragment by lazy { HomePodFragment() }
  }
  ...
  override fun onViewCreated(
    ...
    binding.rvBids.apply {
      ...
      adapter = this@HomePodFragment.adapter
